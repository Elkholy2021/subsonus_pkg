...
public:
  ...
  : Node("minimal_publisher"), count_(0)
  {
    ...
    server = gethostbyname("192.168.1.228");
    if(server == NULL)
    {
    ...
    publisher_rotation = this->create_publisher<std_msgs::msg::Float64MultiArray>("subsea/rotation_matrix", 1000);
    publisher_ = this->create_publisher<geometry_msgs::msg::PoseStamped>("subsea/pose", 1000);
    publisher_sub = this->create_publisher<geometry_msgs::msg::PoseStamped>("subsea/pose_tracked_surface", 1000);
    publisher_marker = this->create_publisher<visualization_msgs::msg::Marker>("subsea/marker", 1000);
